...
document.write('Користувачі зі статусом true:<br>');
for (let i = 0; i < users.length; i++) {
    if (users[i].status === true) {
        document.write('Name: ' + users[i].name + ', age: ' + users[i].age + ', status: ' + users[i].status + '<br>');
    }
}

document.write('Користувачі зі статусом false:<br>');
for (let i = 0; i < users.length; i++) {
...
document.write('Користувачі, які старші за 30 років:<br>');
for (let i = 0; i < users.length; i++) {
    if (users[i].age > 30) {
        document.write('Name: ' + users[i].name + ', age: ' + users[i].age + ', status: ' + users[i].status + '<br>');
    }
